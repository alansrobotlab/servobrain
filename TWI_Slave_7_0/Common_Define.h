...
#define BOOT_DELAY                  6		// Amount of time to wait in bootloader before jumping to application
#define BOOTLOADER_START_DELAY		1		// Amount of time to wait before starting bootloader
